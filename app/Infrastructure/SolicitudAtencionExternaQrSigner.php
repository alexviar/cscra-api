...
class SolicitudAtencionExternaQrSigner {
    ...
    function sign($solicitud, $key){
        ...
        $msg = new Sign1Message(
            ...
            ByteStringObject::create(
                MapObject::create()
                ->add(UnsignedIntegerObject::create(CWT::SUB_KEY), TextStringObject::create($solicitud->paciente->id))
                ->add(UnsignedIntegerObject::create(CWT::AUD_KEY), TextStringObject::create($solicitud->proveedor->razon_social))
                ...
                ->add(NegativeIntegerObject::create(-65537), 
                    ListObject::create()
                        ...
                        ->add(TextStringObject::create($solicitud->paciente->matriculaCompleta))
                        ->add(TextStringObject::create($solicitud->paciente->nombreCompleto))
                        ->add(TextStringObject::create($solicitud->prestacion))
                )
                ->__toString()                
            )
        );
